  ...
  return (
    <>
     <div className=" relative z-50">
       {
        media ? (<div className="flex justify-between m-2.5">
          <NavLink
            to={"/"}
            end
            className={({ isActive }) =>
          ...
          >
            <Mylogo yourlatter={data} className="flex grow-0.4 relative z-20" />
          </NavLink>

          <button className="flex justify-center" onClick={(e) => hendalclick(e)}>
            {media2 ? (
              ...
              `}>
                ...
                <nav className="decoration-none uppercase text-[#E5F48C] p-1.5 
      ...
      font-[Audiowide]">
            ...
            {media2 ? (
              <AiOutlineClose className={`text-6xl text-white transition-all duration-1000 rotate-180`} />
            ) : (
              <AiOutlineBars className={`text-5xl text-white transition-all duration-1000 rotate-0`} />
            )}
          </button>
