...
const Curser= forwardRef((prop,ref) =>{
  ...
  return (
    <>
      <div ref={ref} className="absolute w-5 h-5 rounded-full bg-gray-500 blur-[25px] opacity-0 shadow-[0_0_70px_60px_#c1c1c1] pointer-events-none transition-all transition-discrete duration-1000"></div>
    </>
  );
});
